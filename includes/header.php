<div id="header">
    <div id="logo" name="logo"> <a href="index.php"><img src="resources/default-logo1.png" width="700" height="100" style="margin-bottom:20px" alt="Analysis of 15th LOK SABHA"></a> </div>
    <!-- end of #logo -->
